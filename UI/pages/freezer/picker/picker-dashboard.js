/* ============================================================
AO-08/15 — Picker view: Dashboard (placeholder) | FIL-ID: UI/pages/freezer/picker/picker-dashboard.js
...
export const pickerDashboardView = defineView({
  ...
  mount(root, ctx) {
    try {
      ...
      h1.textContent = "Plock – Dashboard";
      ...
      hint.textContent = "Placeholder-vy (AO-08/15).";
      ...
      boxTitle.textContent = "Här kommer plock-dashboard att monteras";

      const boxText = document.createElement("div");
      boxText.style.opacity = "0.75";
      boxText.style.fontSize = "13px";
      boxText.style.marginTop = "6px";
      boxText.textContent = "Exempel: dagens plock, genvägar, saldo-check, historik-kort.";
